...
| Change | Result |
| --- | --- |
| `workbook`, `data`, `datasource`, `datasourceStorage`, `presentation` | New generation, `reason: "input-reset"` |
| `editors`, `protectionResolver`, `mutationPolicy`, `transactionResourceLimits` | New generation, `reason: "input-reset"` |
