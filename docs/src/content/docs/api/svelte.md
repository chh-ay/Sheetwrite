...
<a class="api-symbol-card" href="/docs/api/svelte/row-bridge/"><span class="api-symbol-card__head"><span class="api-symbol-badge" data-kind="class" aria-hidden="true">C</span><code>RowBridge</code></span><span class="api-symbol-card__desc">Projects canonical document transactions into host-owned row changes.</span></a>
</div>
...
<a class="api-symbol-card" href="/docs/api/svelte/row-bridge-projection/"><span class="api-symbol-card__head"><span class="api-symbol-badge" data-kind="interface" aria-hidden="true">I</span><code>RowBridgeProjection</code></span><span class="api-symbol-card__desc">Result of projection or reconciliation.</span></a>
<a class="api-symbol-card" href="/docs/api/svelte/sheetwrite-grid-props/"><span class="api-symbol-card__head"><span class="api-symbol-badge" data-kind="interface" aria-hidden="true">I</span><code>SheetwriteGridProps</code></span><span class="api-symbol-card__desc">Advanced Svelte adapter props with inferred host row identity.</span></a>
...
<a class="api-symbol-card" href="/docs/api/svelte/row-bridge-delta/"><span class="api-symbol-card__head"><span class="api-symbol-badge" data-kind="type" aria-hidden="true">T</span><code>RowBridgeDelta</code></span><span class="api-symbol-card__desc">Every possible projection produced by a row bridge.</span></a>
<a class="api-symbol-card" href="/docs/api/svelte/row-bridge-handler/"><span class="api-symbol-card__head"><span class="api-symbol-badge" data-kind="type" aria-hidden="true">T</span><code>RowBridgeHandler</code></span><span class="api-symbol-card__desc">Callback accepted by imperative and framework adapters.</span></a>
<a class="api-symbol-card" href="/docs/api/svelte/row-bridge-id/"><span class="api-symbol-card__head"><span class="api-symbol-badge" data-kind="type" aria-hidden="true">T</span><code>RowBridgeId</code></span><span class="api-symbol-card__desc">A stable host identity for one data-space row.</span></a>
