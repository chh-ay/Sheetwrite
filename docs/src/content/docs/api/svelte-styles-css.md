---
title: "@sheetwrite/svelte/styles.css"
description: "API reference for @sheetwrite/svelte/styles.css."
---
<span class="api-status" data-status="asset">asset</span>

**CSS or binary asset entry point.** Import this entry point as `@sheetwrite/svelte/styles.css`.
