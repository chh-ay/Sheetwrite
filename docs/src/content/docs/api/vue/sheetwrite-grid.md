...
```ts generated
const SheetwriteGrid: ComponentPublicInstanceConstructor<
  CreateComponentPublicInstanceWithMixins<
    ToResolvedProps<
      ...
      }>,
      {
        ...
        "active-sheet-change": (
          _event: GridEvents["active-sheet"],
        ) => boolean;
    ...
    > &
      Readonly<{
        ...
        "onEdit-begin"?: ((_event: { addr: CellAddress }) => any) | undefined;
        "onEdit-commit"?:
          | ((_event: { addr: CellAddress; value: CellValue }) => any)
          | undefined;
        "onGrid-change"?: ((_event: ChangeEvent) => any) | undefined;
        "onSelection-change"?:
          ((_selection: Selection | null) => any) | undefined;
        "onViewport-change"?:
          | ((_event: {
              scrollTop: number;
              firstRow: number;
          ...
          | undefined;
        "onActive-sheet-change"?:
          ((_event: { sheet: SheetId }) => any) | undefined;
...
> &
  ...
  (new () => InstanceType<typeof SheetwriteGridComponent> &
